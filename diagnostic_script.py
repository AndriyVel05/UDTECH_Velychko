"""
Diagnostic script to debug the builder loading issue.
Run this to see what happens after login.
"""
...
try:
    ...
    # Step 4: Check for canvas
    print("\n[4] Looking for canvas elements...")
    
    # Try to find all canvas elements
    ...
    # Still save screenshot on error
    try:
